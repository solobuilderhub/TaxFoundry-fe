...
import { Co17FormView } from "./paper/co17-form-view";
...
export const quebec = defineSchedule({
	...
	programs: ["CO17"],
	formView: (props) => createElement(Co17FormView, props),
	schema: defineSchema({
		sections: [
			section(
				"sbd",
				...
				[
					...
					f.money("businessLimit", "Québec business limit (line 420c)", {
						description:
							"Blank = $500,000. Enter the shared limit for an associated group.",
					}),
				],
				{
					variant: "card",
