...
import { Schedule9FormView } from "./paper/schedule9-form-view";
 ...
 *
 * `AlbertaSredCredit9Values` itself is now generated from
...
export const albertaSredCredit9 = defineSchedule({
	...
	programs: ["AT1"],
	formView: (props) => createElement(Schedule9FormView, props),
