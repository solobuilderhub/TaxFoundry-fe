...
export const AT1_SCHEDULE_21_SECTIONS: readonly PaperSectionDef[] = [
  ...
  { id: "limited-partnership", title: "Continuity of limited partnership losses", description: "Page 2. One row per partnership, not per jurisdiction — a table, so every line here repeats per occurrence. The total of column 139 carries to Schedule 12, line 072." },
  { id: "non-capital-by-year", title: "Analysis of balance of non-capital losses by year of origin", description: "Page 3. Twenty-one rows — the current year, then the twenty preceding taxation years — so every line repeats per occurrence." },
  { id: "other-losses-by-year", title: "Analysis of balance of losses by year of origin", description: "Page 4. The same twenty-one rows for farm, restricted farm and listed personal property losses, with one balance per pool and no formula." },
...
export const AT1_SCHEDULE_21_FIELDS: readonly PaperField[] = [
  ...
  { line: "021139001", caption: "Limited partnership loss applied", kind: "money", role: "input", section: "limited-partnership", to: { form: "AT1SCH12", line: "012072001", note: "Carry forward the total of column 139 to Schedule 12, line 072." } },
  { line: "021141001", caption: "Limited partnership losses closing balance (133 + 135 + 137 - 139)", kind: "money", role: "computed", section: "limited-partnership" },
  { line: "021151001", caption: "Year of origin", kind: "code", role: "computed", section: "non-capital-by-year", note: "0 for the current year, 1-20 for each preceding taxation year." },
  { line: "021153001", caption: "Tax year end", kind: "date", role: "input", section: "non-capital-by-year" },
  { line: "021155001", caption: "Balance at the beginning of year", kind: "money", role: "input", section: "non-capital-by-year" },
  { line: "021157001", caption: "Loss incurred in current year", kind: "money", role: "carried-in", section: "non-capital-by-year", from: { form: "AT1SCH21", line: "021021001", note: "The current-year row takes this schedule's own line 021." } },
  { line: "021159001", caption: "Adjustments and transfers", kind: "money", role: "input", section: "non-capital-by-year" },
  { line: "021165001", caption: "Loss carried back", kind: "money", role: "carried-in", section: "non-capital-by-year", from: { form: "AT1SCH21", line: "021047001", note: "The current-year row takes the pool's own total carried back." } },
  { line: "021167001", caption: "Applied to reduce taxable income", kind: "money", role: "input", section: "non-capital-by-year" },
  { line: "021169001", caption: "Balance at end of year 155 + 157 +159 - 165 - 167", kind: "money", role: "computed", section: "non-capital-by-year" },
  { line: "021181001", caption: "Year of origin", kind: "code", role: "computed", section: "other-losses-by-year", note: "0 for the current year, 1-20 for each preceding taxation year." },
  { line: "021183001", caption: "Farm losses *", kind: "money", role: "input", section: "other-losses-by-year" },
  { line: "021185001", caption: "Restricted farm losses", kind: "money", role: "input", section: "other-losses-by-year" },
  { line: "021187001", caption: "Listed personal property losses", kind: "money", role: "input", section: "other-losses-by-year", note: "Not filed beyond the 7th preceding year — a listed-personal-property loss expires after seven taxation years." },
