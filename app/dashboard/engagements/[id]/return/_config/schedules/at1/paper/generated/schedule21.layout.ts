...
export const AT1_SCHEDULE_21_FIELDS: readonly PaperField[] = [
  ...
  { line: "021002001", caption: "RIFE deducted in the year under paragraph 111(1)(a.1) of ITA (enter as a positive amount)", kind: "money", role: "input", section: "current-year", note: "RIFE is restricted interest and financing expenses." },
  ...
  { line: "021015001", caption: "Line 001 - line 013: (if positive, enter \"0\")", kind: "money", role: "computed", section: "current-year" },
  { line: "021017001", caption: "Deduct: ITA section 110.5 or subparagraph 115(1)(a)(vii) additions for foreign tax credits", kind: "money", role: "input", section: "current-year", to: { form: "AT1SCH12", line: "012082001", note: "Carry forward to Schedule 12, line 082" } },
  { line: "021019001", caption: "Add: Current year farm loss", kind: "money", role: "input", section: "current-year" },
  { line: "021021001", caption: "Non-capital loss for the current year: Line 015 - 017 + 019 (if positive, enter \"0\")", kind: "money", role: "computed", section: "current-year", note: "If negative, enter this amount into line 037 as a positive." },
