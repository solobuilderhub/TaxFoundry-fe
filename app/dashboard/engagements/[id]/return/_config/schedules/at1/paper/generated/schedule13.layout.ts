...
export const AT1_SCHEDULE_13_FIELDS: readonly PaperField[] = [
  ...
  { line: "013005001", caption: "Cost of acquisitions during the year", kind: "money", role: "input", section: "grid", note: "New property must be available for use." },
  { line: "013007001", caption: "Net adjustments", kind: "money", role: "input", section: "grid", note: "SIGNED — negative amounts are shown in brackets." },
  { line: "013009001", caption: "Proceeds of dispositions", kind: "money", role: "input", section: "grid", note: "Not to exceed the capital cost." },
  { line: "013013001", caption: "CCA rate", kind: "rate", role: "input", section: "grid", note: "Reported as NA for classes with no fixed rate, such as 13 and 14." },
  { line: "013015001", caption: "Recapture of capital cost allowance", kind: "money", role: "input", section: "grid" },
  ...
  { line: "013035001", caption: "UCC adjustment for AIIP", kind: "money", role: "input", section: "grid", note: "The accelerated uplift — a different factor from the half-year rule below." },
  { line: "013037001", caption: "UCC adjustment for property other than AIIP", kind: "money", role: "input", section: "grid", note: "The half-year rule: half of net additions is held out of this year’s base." },
  { line: "013039001", caption: "Of which designated immediate expensing property (DIEP)", kind: "money", role: "input", section: "grid", note: "A subset of column 3, not an addition to it." },
