...
export const AT1_SCHEDULE_10_SECTIONS: readonly PaperSectionDef[] = [
  ...
  { id: "carry-forward", title: "Balance of current year loss available for carry forward", description: "Amount A minus amount B, per column." },
];
