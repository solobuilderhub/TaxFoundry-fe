/**
 * Alberta charitable donations & gifts deduction (AT1SCH20) — paper Form View layout.
 *
...
export const AT1_SCHEDULE_20_SECTIONS: readonly PaperSectionDef[] = [
  ...
  { id: "carryforward", title: "Amount available for carryforward by year of origin", description: "Filed only when at least one category figure is entered. Charitable donations (002-018) and gifts (062-078) are each ONE combined continuity on this schedule; this block reports how much of the gifts pool's closing balance belongs to each of the three federal source categories, plus the medicine-gift deduction (ITA s.110.1(1)(a.1)), which nothing else on this schedule models at all.", printedBefore: "If the corporation elects to differ its Alberta claim for additional deduction for gifts of medicine (line 660 on Federal T2 Schedule 2), please enter the Alberta amount on Schedule 12, line 40, the federal amount on Schedule 12, line 41 and provide the explanation of the difference on Alberta Schedule 12, line 48." },
];
...
export const AT1_SCHEDULE_20_FIELDS: readonly PaperField[] = [
  ...
  { line: "020006001", caption: "Charitable donations at the beginning of the taxation year", kind: "money", role: "computed", section: "charitable", note: "Line 002 minus line 004." },
  ...
  { line: "020016001", caption: "Amount applied against taxable income Not exceeding the lesser of: total donations available (line 014) and maximum deduction calculation (line 048), not exceeding the Alberta net income for tax purposes (schedule 12, line 054)", kind: "money", role: "input", section: "charitable", note: "Capped by the Area B maximum at line 048.", to: { form: "AT1SCH12", line: "012056001", note: "Printed on the form: \"Carry forward the amount at line 016 to Schedule 12, line 056\"." } },
  ...
  { line: "020066001", caption: "Gifts balance at the beginning of the taxation year", kind: "money", role: "computed", section: "gifts", note: "Line 062 minus line 064." },
  ...
  { line: "020076001", caption: "Deduct: Amount applied against taxable income", kind: "money", role: "input", section: "gifts", note: "Capped by the Area B maximum at line 048.", to: { form: "AT1SCH12", line: "012058001", note: "Printed on the form: \"Carry forward the amount at line 076 to Schedule 12, line 058\"." } },
  ...
  { line: "020098001", caption: "Gifts of certified ecological sensitive land available for carryforward", kind: "money", role: "input", section: "carryforward", requirement: "optional" },
