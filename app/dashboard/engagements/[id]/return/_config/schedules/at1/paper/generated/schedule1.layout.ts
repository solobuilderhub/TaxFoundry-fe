...
export const AT1_SCHEDULE_1_SECTIONS: readonly PaperSectionDef[] = [
  ...
  { id: "calculation", title: "Calculation of the Alberta Small Business Deduction", description: "Seven columns across six rate periods, day-weighted. This engine does NOT compute the deduction this way — see the note on line 031 — so the columns are transcribed (AT1_SCHEDULE_1_COLUMNS) rather than filed." },
...
export const AT1_SCHEDULE_1_FIELDS: readonly PaperField[] = [
  { line: "001001001", caption: "Is the corporation associated with one or more Canadian-controlled private corporations?", kind: "flag", role: "computed", section: "association", note: "NOT FILED on this schedule. The answer transmits at jacket line 000001001, which carries this identical caption; `schedule1Values` must never put it at 001001001, and four accepted certification samples are why. Derived from the federal associated-group facts rather than asked again here. A \"Yes\" is what makes Area A on page 2 mandatory.", to: { form: "AT1", line: "000001001", note: "The answer transmits on the AT1 jacket, at 000001001 — never at 001001001." } },
  ...
  { line: "001044001", caption: "Percentage of the Business Limit", kind: "rate", role: "computed", section: "agreement", note: "NOT COLLECTED OR FILED. The page computes 045 FROM this (\"$200,000 X % in Col 044\") and its own footnote says the split must be the same one used on federal Schedule 23; this product collects the allocated dollars at 045 directly instead, so the percentage the dollars came from is never stated and the federal cross-check cannot be made. The page totals this column at 100%, which is the check that would catch an over-allocated group.", footnoteMarks: [3] },
