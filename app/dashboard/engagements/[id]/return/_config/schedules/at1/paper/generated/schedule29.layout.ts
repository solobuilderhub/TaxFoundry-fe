...
export const AT1_SCHEDULE_29_FIELDS: readonly PaperField[] = [
  ...
  { line: "029102001", caption: "If the corporation is associated (line 100 = Yes), enter the allocated expenditure limit amount from applicable line 240 on page 3", kind: "money", role: "computed", section: "limit", note: "This corporation’s own line 240 on page 3 (row 1, the claiming corporation), carried here — filed only when line 100 is Yes.", sourceText: "applicable line 240 on page 3" },
  ...
  { line: "029108001", caption: "Maximum expenditure limit for the year (line 102 or line 104 as applicable)", kind: "money", role: "computed", section: "limit", note: "Feeds lines 110, 112 and 125. Filed on the associated path (= line 102); not yet on the non-associated path — see line 104’s note." },
