...
import { Schedule15FormView } from "./paper/schedule15-form-view";
 ...
 * `assembleSchedule15`. `AlbertaResourceDeductions15Values` itself (and its
 * 14 nested row types) is now generated from
