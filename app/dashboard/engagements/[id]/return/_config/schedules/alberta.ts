  ...
  schema: defineSchema({
    sections: [
      ...
      section(
        ...
        "Corporate status",
        [
          f.radio("associatedWithCcpcs", "Associated with one or more CCPCs? (line 001)", YES_NO, {
            required: true,
          }),
          f.radio("windUpOfSubsidiary", "Wind-up of a subsidiary under ITA s.88? (line 031)", YES_NO, {
            required: true,
          }),
          f.radio(
          ...
          f.radio("taxYearEndChanged", "Tax year end changed since the last return? (line 038)", YES_NO, {
            required: true,
          }),
          f.radio("finalReturn", "Is this the final return? (line 050)", YES_NO, { required: true }),
          f.radio(
            "transferOfProperty",
