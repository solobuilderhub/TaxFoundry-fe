			...
			section(
				...
				[
					f.money(
						...
						"Net foreign non-business income (line 110)",
						{
							description: "Foreign property/investment income (gross, in CAD)",
						},
					),
					f.money(
						"foreignNonBusinessTaxPaid",
						"Foreign non-business income tax paid (line 120)",
					),
				],
				{ variant: "card", cols: 2 },
			),
			section(
				...
				[
					f.money(
						...
						"Net foreign business income (line 210)",
						{ description: "In CAD" },
					),
					f.money(
						"foreignBusinessTaxPaid",
						"Foreign business income tax (line 220)",
					),
					f.money(
						"openingBusinessFtcPool",
						"Unused business FTC carried forward (line 348)",
						{
							description:
								"From prior years (10-yr limit). Auto-filled from last year on compute",
						},
					),
				],
				{
