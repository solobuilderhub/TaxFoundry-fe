		...
		sections: [
			section(
				...
				[
					...
					f.money(
						"reservesNotDeducted",
						"Reserves not deducted for tax (line 101)",
					),
					f.money(
						"loansAndAdvances",
						"Loans & advances to the corporation (line 108)",
					),
					f.money(
						"bondsAndDebentures",
						"Bonds, debentures, notes, mortgages (line 109)",
					),
					f.money(
						"dividendsDeclaredUnpaid",
						"Dividends declared but unpaid (line 110)",
					),
					f.money(
						"otherLongTermDebt",
						"Other debt outstanding > 365 days (line 111)",
					),
					f.money(
						"deferredForexGains",
						"Deferred unrealized FX gains (line 107)",
					),
				],
				{
					variant: "card",
					cols: 2,
					description:
						"Year-end amounts added to arrive at capital (line 190).",
				},
			),
			section(
				"deductions",
				...
				[
					...
					f.money(
						"deferredForexLosses",
						"Deferred unrealized FX losses (line 124)",
					),
					f.money(
						"patronageDeducted",
						"Patronage dividends deducted (s.135(1)) (line 123)",
					),
				],
				{ variant: "card", cols: 2 },
			),
			section(
				...
				[
					f.money(
						...
						"Shares of other corporations (line 401)",
					),
					f.money(
						"loansToOtherCorporations",
						"Loans / advances to other corporations (line 402)",
					),
					f.money(
						"bondsOfOtherCorporations",
						"Bonds / debt of other corporations (line 403)",
					),
					f.money(
						"longTermDebtOfFinancialInstitution",
						"Long-term debt of a financial institution (line 404)",
					),
					f.money(
						"dividendsReceivable",
						"Dividends receivable from other corporations (line 405)",
					),
					f.money(
						"partnershipObligations",
						"Qualifying-partnership obligations (line 406)",
					),
					f.money(
						"partnershipInterestAsset",
						"Interest in a partnership (line 407)",
					),
				],
				{
					variant: "card",
