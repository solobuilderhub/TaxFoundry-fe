...
const EVENTS = [
	...
	{
		value: "windUpOfSubsidiary",
		label: "Wind-up of a subsidiary into the parent",
	},
];
		...
		sections: [
			section(
				...
				[
					f.switch(
						"isFirstReturn",
						"First return after incorporation, amalgamation or wind-up",
					),
				],
				{
					variant: "card",
			...
			section(
				...
				[
					...
					f.date("eventDate", "Date of the event", {
						condition: shownWhenFirst,
					}),
					f.text(
						"predecessorBusinessNumbers",
						"Predecessor / subsidiary Business Numbers (lines 300 / 500)",
						{
			...
			section(
				...
				[
					...
					f.money("openingLiabilities", "Total liabilities", {
						condition: shownWhenFirst,
					}),
					f.money("openingEquity", "Total equity", {
						condition: shownWhenFirst,
					}),
				],
				{
