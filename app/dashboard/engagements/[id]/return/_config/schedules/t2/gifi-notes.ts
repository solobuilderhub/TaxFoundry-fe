	...
	schema: defineSchema({
		sections: [
			section(
				...
				[
					f.switch(
						"financialStatementsIncluded",
						"Financial statements are included / attached",
					),
					f.switch(
						"preparedByAccountant",
				...
				],
				{
					...
					cols: 1,
					description:
						"Mandatory even when empty. Declares who prepared the statements.",
				},
			),
		],
	}),
