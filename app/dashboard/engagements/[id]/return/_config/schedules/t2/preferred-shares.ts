	...
	schema: defineSchema({
		sections: [
			section(
				...
				[
					f.money(
						"shortTermPreferredDividends",
						"On short-term preferred shares (line 220)",
						{
							description: "Taxed at 40% above the allowance",
						},
					),
					f.money(
						"otherPreferredDividends",
						"On other taxable preferred shares (lines 230 / 240)",
						{
							description:
								"Taxed at 25% above the allowance, or 40% with the election below",
						},
					),
					f.switch(
						"electedUnder191_2",
			...
			section(
				...
				[
					f.money(
						"priorYearPreferredDividends",
						"Preferred dividends paid LAST year",
						{
							description:
					...
					f.money(
						"allocatedAllowance",
						"Allowance allocated to this corporation (line 140)",
						{
