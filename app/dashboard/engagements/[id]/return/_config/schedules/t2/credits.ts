	...
	schema: defineSchema({
		sections: [
			section(
				...
				[
					f.money(
						"sredQualifiedExpenditures",
						"Total qualified SR&ED expenditures (line 380)",
						{
							description:
								"Current + capital R&D expenditures qualifying for the ITC (from Form T661)",
						},
					),
					f.money("openingItcPool", "Opening ITC pool", {
						description:
							"Non-refundable credit carried forward. Auto-filled from last year on compute",
					}),
				],
				{
					variant: "card",
