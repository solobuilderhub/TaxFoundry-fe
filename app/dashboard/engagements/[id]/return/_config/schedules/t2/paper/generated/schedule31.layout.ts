...
export const T2_SCHEDULE_31_FIELDS: readonly PaperField[] = [
  ...
  { line: "400", caption: "For an associated corporation If associated, the allocation of the SR&ED expenditure limit, as provided on Schedule 49 6", kind: "money", role: "input", section: "sred-expenditures" },
  ...
  { line: "420", caption: "Current SR&ED expenditures (from line 350 in Part 8) or × 15% = 11B the expenditure limit (from line 410), whichever is less 8", kind: "money", role: "input", section: "sred-expenditures" },
  ...
  { line: "460", caption: "qualifying expenditure eligible for the 35% SR&ED × 35% = 11F ITC rate 9", kind: "money", role: "input", section: "sred-expenditures" },
