...
export const T2_SCHEDULE_31_FIELDS: readonly PaperField[] = [
  ...
  { line: "382", caption: "Are you an ECPC as defined in subsection 127(9)?", kind: "flag", role: "input", section: "sred-expenditures" },
  { line: "385", caption: "Is the corporation associated with another CCPC for the purpose of calculating the SR&ED expenditure limit?", kind: "flag", role: "input", section: "sred-expenditures" },
