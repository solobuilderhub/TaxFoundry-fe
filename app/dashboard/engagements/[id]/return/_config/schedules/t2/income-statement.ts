	...
	schema: defineSchema({
		sections: [
			section(
				...
				"Revenue",
				[
					f.money("revenue", "Total sales / revenue", {
						fullWidth: true,
						description: "GIFI 8299",
					}),
				],
				{ variant: "card", cols: 1 },
			),
			section(
				...
				"Operating expenses",
				[
					f.money("costOfSales", "Cost of sales", {
						description: "GIFI 8518 (Total Cost of Sales)",
					}),
					f.money("salariesAndWages", "Salaries & wages", {
						description: "GIFI 9060",
					}),
