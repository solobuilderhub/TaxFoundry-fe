		...
		sections: [
			section(
				...
				[
					...
					f.money("accountsReceivable", "Accounts receivable", {
						description: "GIFI 1060",
					}),
			...
			section(
				...
				"Liabilities",
				[
					f.money("accountsPayable", "Accounts payable", {
						description: "GIFI 2620",
					}),
					f.money("loansPayable", "Loans & long-term debt", {
						description: "GIFI 2700",
					}),
			...
			section(
				...
				"Shareholder equity",
				[
					f.money("shareCapital", "Share capital", {
						description: "GIFI 3500",
					}),
					f.money("retainedEarnings", "Retained earnings", {
						description: "GIFI 3600",
					}),
				],
				{ variant: "card", cols: 2 },
			),
