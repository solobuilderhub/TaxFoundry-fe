	...
	schema: defineSchema({
		sections: [
			section(
				...
				[
					f.money("charitable", "Charitable donations (line 210)", {
						description: "75% of net income cap",
					}),
					f.money("cultural", "Cultural gifts (line 410)"),
					f.money("ecological", "Ecological gifts (line 520)"),
					f.money(
						"openingDonationPool",
						"Unclaimed donations carried forward (line 240)",
						{
							description:
								"From prior years (5-yr limit). Auto-filled from last year on compute",
						},
					),
				],
				{
