		...
		sections: [
			section(
				...
				[
					f.money(
						...
						"Active business income (ABI) (line 400)",
						{ fullWidth: true },
					),
					f.money("businessLimit", "Business limit (line 410)", {
						description:
							"This corp's share of $500,000 (see associated corps below)",
					}),
					...
					f.money(
						"aaii",
						"Adjusted aggregate investment income, PRIOR year (Schedule 7 line 745)",
						{
							description:
				...
				],
				{
					...
					cols: 2,
					description:
						"Inputs to the SBD calculation and its grinds (Schedule 7).",
				},
			),
			section(
				"aiiDetail",
				...
				[
					f.money(
						"aiiDetail.taxableCapitalGains",
						"Eligible taxable capital gains (002)",
					),
					f.money(
						"aiiDetail.allowableCapitalLosses",
						"Eligible allowable capital losses, incl. ABILs (012)",
					),
					f.money(
						"aiiDetail.netCapitalLossesClaimed",
						"Net capital losses of previous years claimed — T2 line 332 (022)",
					),
					f.money(
						"aiiDetail.incomeFromProperty",
						"Total income from property (032)",
					),
					f.money("aiiDetail.exemptIncome", "Exempt income (042)"),
					f.money(
						"aiiDetail.agriInvestFundReceived",
						"AgriInvest Fund No. 2 received (052)",
					),
					f.money(
						"aiiDetail.taxableDividendsDeductible",
						"Taxable dividends deductible, s.113(1)(c) (062)",
					),
					f.money(
						"aiiDetail.trustPropertyIncome",
						"Business income from a trust interest, s.108(5)(a) (072)",
					),
					f.money(
						"aiiDetail.lossesFromProperty",
						"Total losses from property (082)",
					),
				],
				{
					variant: "card",
			...
			section(
				...
				[
					...
					f.money(
						"aaiiDetail.incomeFromProperty",
						"Total income from property (715)",
					),
					f.money("aaiiDetail.exemptIncome", "Exempt income (720)"),
					f.money(
						"aaiiDetail.agriInvestFundReceived",
						"AgriInvest Fund No. 2 received (725)",
					),
					f.money(
						"aaiiDetail.dividendsFromConnectedCorporations",
						"Dividends from connected corporations (730)",
					),
					f.money(
						"aaiiDetail.trustPropertyIncome",
						"Business income from a trust interest, s.108(5)(a) (735)",
					),
					f.money(
						"aaiiDetail.lossesFromProperty",
						"Total losses from property (740)",
					),
					f.money(
						"aaiiDetail.subsection91_4Deduction",
						"Amount deducted under s.91(4) — FAPI (741)",
					),
				],
				{
					variant: "card",
